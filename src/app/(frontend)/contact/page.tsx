...
export const metadata: Metadata = {
  title: "Contact Us — MiAfrica",
  description: "Get in touch with MiAfrica. Reach out to our Cape Town concierge team to plan your custom South African tour experience.",
};
              ...
              <div className="space-y-6 pt-2">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@miafrica.com" className="font-medium text-primary hover:text-secondary transition-colors text-base">
                      hello@miafrica.com
                    </a>
                  </div>
                </div>
